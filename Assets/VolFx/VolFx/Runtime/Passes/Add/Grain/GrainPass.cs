...
namespace VolFx
{
    ...
    public class GrainPass : VolFx.Pass
    {
        ...
        public override bool Validate(Material mat)
        {
            ...
            mat.SetVector(s_Adj, new Vector4(settings.m_Hue.value, (settings.m_Saturation.value + 1f) * (settings.m_Saturation.value > 0f ? 7f : 1f), settings.m_Brightness.value, 1f - settings.m_Alpha.value));
